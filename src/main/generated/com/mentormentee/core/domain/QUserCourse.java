...
public class QUserCourse extends EntityPathBase<UserCourse> {
    ...
    private static final long serialVersionUID = 360844835L;
    ...
    public final EnumPath<GradeStatus> gradeStatus = createEnum("gradeStatus", GradeStatus.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final EnumPath<IsMajor> isMajor = createEnum("isMajor", IsMajor.class);
